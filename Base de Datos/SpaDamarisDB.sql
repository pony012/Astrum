...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2014 a las 09:30:51
...
`IDPadecimiento` int(10) NOT NULL,
  ...
  `Embarazo` decimal(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT AUTO_INCREMENT=1 ;
...
--
DROP VIEW IF EXISTS `V_TotalComprado`;
...
--
DROP VIEW IF EXISTS `V_TotalVendido`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `V_AjusteSalida` AS select `ae`.`IDAjusteSalida` AS `IDAjusteSalida`,`ae`.`IDMovimientoAlmacen` AS `IDMovimientoAlmacen`,`ae`.`Folio` AS `Folio`,`aet`.`Tipo` AS `Tipo`,`p`.`IDProveedor` AS `IDProveedor`,concat_ws(' ',`p`.`Nombre`,`p`.`ApellidoPaterno`,`p`.`ApellidoMaterno`) AS `Proveedor`,`e`.`IDEmpleado` AS `IDEmpleado`,concat_ws(' ',`e`.`Nombre`,`e`.`ApellidoPaterno`,`e`.`ApellidoMaterno`) AS `Empleado`,`ae`.`Observaciones` AS `Observaciones` from ((((`ajustesalida` `ae` join `ajustesalidatipo` `aet` on((`aet`.`IDAjusteSalidaTipo` = `ae`.`IDAjusteSalidaTipo`))) left join `proveedor` `p` on(((`p`.`IDProveedor` = `ae`.`IDProveedor`) and (`p`.`Activo` = 'S')))) join `movimientoalmacen` `ma` on((`ma`.`IDMovimientoAlmacen` = `ae`.`IDMovimientoAlmacen`))) join `empleado` `e` on(((`ma`.`IDEmpleado` = `e`.`IDEmpleado`) and (`e`.`Activo` = 'S'))));
...
--
ALTER TABLE `AjusteEntrada`
MODIFY `IDAjusteEntrada` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `AjusteEntradaDetalle`
--
ALTER TABLE `AjusteEntradaDetalle`
MODIFY `IDAjusteEntradaDetalle` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `AjusteSalida`
MODIFY `IDAjusteSalida` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `AjusteSalidaDetalle`
--
ALTER TABLE `AjusteSalidaDetalle`
MODIFY `IDAjusteSalidaDetalle` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `ExploracionInicial`
MODIFY `IDExploracionInicial` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `HistorialMedico`
MODIFY `IDHistorialMedico` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=80;
--
...
--
ALTER TABLE `ProductoServicio`
MODIFY `IDProductoServicio` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `Recepcion`
MODIFY `IDRecepcion` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT de la tabla `RecepcionDetalle`
--
ALTER TABLE `RecepcionDetalle`
MODIFY `IDRecepcionDetalle` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `Remision`
--
ALTER TABLE `Remision`
MODIFY `IDRemision` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT de la tabla `RemisionDetalle`
--
ALTER TABLE `RemisionDetalle`
MODIFY `IDRemisionDetalle` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
