...
--
-- Servidor: localhost
-- Tiempo de generación: 05-10-2014 a las 22:31:28
...
`IDExistencia` int(10) NOT NULL,
  `FechaReferencia` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `IDProductoServicio` int(10) NOT NULL,
...
`IDMovimientoAlmacen` int(10) NOT NULL,
  ...
  `MovimientoAlmacenFecha` date NOT NULL,
  `IDEmpleado` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `Cargo`
MODIFY `IDCargo` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
